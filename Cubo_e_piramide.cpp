...
GLuint tfLoc, vLoc, mvLoc, projLoc;
int width, height;
...
void init(GLFWwindow* window) {
	renderingProgram = createShaderProgram("vertex_ShaderSource.glsl", "fragment_ShaderSource.glsl");
	cameraX = 0.0f; cameraY = 0.0f; cameraZ = 20.0f;//a camera fica aqui
	cubeLocX = -2.0f; cubeLocY = -4.0f; cubeLocZ = 0.0f; // shift down Y to reveal perspective
...
void display(GLFWwindow* window, double currentTime) {
	...
	timeFactor = ((float)currentTime)/15; // uniform for the time factor
...
int main(void) { // main() is unchanged from before
	...
	GLFWwindow* window = glfwCreateWindow(1200, 800, "Chapter 4 - program 3", NULL, NULL);
